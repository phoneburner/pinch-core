...
class PropertyFixture
{
    ...
    private int|null $nullable_float_property = null; // @phpstan-ignore-line
    ...
    private iterable|null $nullable_iterable_property = null; // @phpstan-ignore-line
    private object|null $nullable_object_property = null; // @phpstan-ignore-line
