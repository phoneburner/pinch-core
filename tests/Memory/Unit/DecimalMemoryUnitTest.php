...
namespace PhoneBurner\Pinch\Tests\Memory\Unit;
...
final class DecimalMemoryUnitTest extends TestCase
{
    ...
    public static function provideFitValues(): \Generator
    {
        ...
        yield 'Large Value Beyond EB' => [2 * ($base ** 6), DecimalMemoryUnit::Exabyte];
        yield 'Very Large Negative Value' => [-2 * ($base ** 6), DecimalMemoryUnit::Exabyte];
    }

    #[Test]
    public function baseConstantHasCorrectValue(): void
    {
        self::assertSame(1000, DecimalMemoryUnit::BASE);
        self::assertSame(DecimalMemoryUnit::BASE, 10 ** 3);
    }

    #[Test]
    public function fitHandlesEdgeCases(): void
    {
        // Test with PHP_INT_MAX - should still return Exabyte
        self::assertSame(DecimalMemoryUnit::Exabyte, DecimalMemoryUnit::fit(\PHP_INT_MAX));

        // Test with PHP_INT_MIN - should return Exabyte (uses abs())
        self::assertSame(DecimalMemoryUnit::Exabyte, DecimalMemoryUnit::fit(\PHP_INT_MIN));
    }
}
