...
namespace PhoneBurner\Pinch\Tests\Container\ObjectContainer;
...
final class MutableObjectContainerTest extends TestCase
{
    ...
    public function callThrowsExceptionForNonCallableString(): void
    {
        ...
        $this->expectExceptionMessage('Value must be an object, got id: string_id, value: (string)not_callable');
    ...
    {
        /** @var MutableObjectContainer<StringWrapper> $container */
        $container = new MutableObjectContainer();
        $container->set('key1', new StringWrapper('123'));
        self::assertTrue($container->contains(new StringWrapper('123'), false)); // non-strict
    }
    ...
    public function containsReturnsFalseIfValueDoesNotExistNonStrict(): void
    {
        ...
        $container = new MutableObjectContainer();
        $container->set('key1', new StringWrapper('123'));
        self::assertFalse($container->contains(new StringWrapper('456'), false)); // non-strict
    }
