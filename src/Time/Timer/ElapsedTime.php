...
readonly class ElapsedTime implements \Stringable
{
    ...
    {
        return $this->convert(NANOSECONDS_IN_SECOND, $precision);
    }

    public function inMilliseconds(int $precision = 2): float
    {
        return $this->convert(NANOSECONDS_IN_MILLISECOND, $precision);
    }

    public function inMicroseconds(int $precision = 0): float
    {
        return $this->convert(NANOSECONDS_IN_MICROSECOND, $precision);
    }
