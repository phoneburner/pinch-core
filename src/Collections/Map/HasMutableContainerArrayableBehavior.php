...
trait HasMutableContainerArrayableBehavior
{
    ...
    /**
     * @template TReturn
     * @param (callable(TValue): TReturn)|(callable(TValue, string): TReturn) $callback
     * @return GenericMapCollection<TReturn> mapping does not necessarily preserve the type of the map implementation
     */
